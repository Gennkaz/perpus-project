...
<body>
    ...
    <div class="container my-5">
        ...
        <div class="mb-5 px-5">
            <h3 class="fw-bold mb-3">Kontak Informasi</h3>
            <p>
        ...
        <div class="mb-5 px-5">
            <h3 class="fw-bold mb-3">Jam Buka</h3>
            <p>
        ...
        <div class="mb-5 px-5">
            <h3 class="fw-bold mb-3">Koleksi</h3>
            <p>
        ...
        <div class="px-5">
            <h3 class="fw-bold mb-3">Langganan Perpustakaan</h3>
            <p>
